export const CareerTimeline = [
  ...
  //   endDate: 'Jun 2020',
  //   position: 'President',
  //   company: "HKUST - Korean Students' Association",
  //   description:
  //     'Led and trained teams of recruits, developing strong leadership and communication skills. Fostered discipline, teamwork, and resilience. Learned the importance of clear communication and structured processes.',
  //   projectIds: [],
  // },
  {
    startDate: 'Aug 2016',
